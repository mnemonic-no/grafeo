package no.mnemonic.services.grafeo.api.validation.constraints;
...
public @interface ServiceNotNull {
  ...
  String message() default "{no.mnemonic.services.grafeo.api.validation.constraints.ServiceNotNull.message}";
