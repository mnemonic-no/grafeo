...
public class ObjectVertexTest extends AbstractGraphTest {
  ...
  public void testCreateVertexFromObject() {
    ...
    Vertex vertex = ObjectVertex.builder().setGraph(getGraph()).setObjectRecord(object).setObjectType(type).build();
  ...
  public void testEdgesWithDirectionBiDirectional() {
    ...
    when(getGraph().getObjectFactDao().searchFacts(notNull())).thenAnswer(
            x -> ResultContainer.<FactRecord>builder().setValues(list(bidirectionalFact).iterator()).build()
    );

    Vertex vertex = ObjectVertex.builder().setGraph(getGraph()).setObjectRecord(source).setObjectType(objectType).build();
  ...
  public void testEdgesWithDirectionInToDestination() {
    ...
    Vertex vertex = ObjectVertex.builder().setGraph(getGraph()).setObjectRecord(destination).setObjectType(objectType).build();
  ...
  public void testEdgesFilterByLabel() {
    ...
    when(getGraph().getObjectFactTypeResolver().factTypeNamesToIds(set(bidirectionalFact.getName())))
            .thenReturn(set(bidirectionalFact.getId()));

    when(getGraph().getObjectFactDao().searchFacts(any()))
  ...
  public void testVerticesFilterByLabel() {
    ...
    when(getGraph().getObjectFactTypeResolver().factTypeNamesToIds(set(factTypeStruct.getName())))
  ...
  public void testEdgesPassesSearchCriteria() {
    ObjectFactGraph timeFilterGraph = createGraph(TraverseParams.builder()
  ...
  public void testEdgesAndRetractions() {
    ObjectFactGraph actGraphNoRetractions = createGraph(TraverseParams.builder()
            .setBaseSearchCriteria(factSearchCriteria)
