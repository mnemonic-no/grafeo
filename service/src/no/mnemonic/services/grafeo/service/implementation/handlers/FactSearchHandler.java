...
public class FactSearchHandler {
   ...
   * <p>
   * If the user has the 'unlimitedGrafeoSearch' permission the result size won't be limited, otherwise the
  ...
  private int calculateLimit(FactSearchCriteria criteria) {
    try {
      securityContext.checkPermission(FunctionConstants.unlimitedGrafeoSearch);
