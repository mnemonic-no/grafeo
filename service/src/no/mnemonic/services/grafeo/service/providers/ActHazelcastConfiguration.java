...
import static no.mnemonic.services.grafeo.service.ti.caches.DistributedFactByHashDaoCache.FACT_BY_HASH_MAP_NAME;
import static no.mnemonic.services.grafeo.service.ti.caches.DistributedFactByIdDaoCache.FACT_BY_ID_MAP_NAME;
import static no.mnemonic.services.grafeo.service.ti.caches.DistributedObjectByIdDaoCache.OBJECT_BY_ID_MAP_NAME;
import static no.mnemonic.services.grafeo.service.ti.caches.DistributedObjectByTypeValueDaoCache.OBJECT_BY_TYPE_VALUE_MAP_NAME;

/**
 * This class contains the Hazelcast configuration required for the ACT implementation to function properly
 ...
 */
public class ActHazelcastConfiguration {
  ...
  /**
   * Apply the required ACT configuration to an existing Hazelcast {@link Config} object.
   *
  ...
  public ActHazelcastConfiguration setDaoCacheFactTimeToLive(@Named("act.dao.cache.fact.ttl") long timeToLive) {
    this.daoCacheFactTimeToLive = Duration.ofMinutes(timeToLive);
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheObjectTimeToIdle(@Named("act.dao.cache.object.ttl") long timeToIdle) {
    this.daoCacheObjectTimeToIdle = Duration.ofMinutes(timeToIdle);
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheFactNearCacheTimeToLive(@Named("act.dao.cache.fact.near.cache.ttl") long timeToLive) {
    this.daoCacheFactNearCacheTimeToLive = Duration.ofMinutes(timeToLive);
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheObjectNearCacheTimeToIdle(@Named("act.dao.cache.object.near.cache.ttl") long timeToIdle) {
    this.daoCacheObjectNearCacheTimeToIdle = Duration.ofMinutes(timeToIdle);
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheFactMaximumCacheSize(@Named("act.dao.cache.fact.size") int maxSize) {
    this.daoCacheFactMaximumCacheSize = maxSize;
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheObjectMaximumCacheSize(@Named("act.dao.cache.object.size") int maxSize) {
    this.daoCacheObjectMaximumCacheSize = maxSize;
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheFactNearCacheMaximumCacheSize(@Named("act.dao.cache.fact.near.cache.size") int maxSize) {
    this.daoCacheFactNearCacheMaximumCacheSize = maxSize;
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setDaoCacheObjectNearCacheMaximumCacheSize(@Named("act.dao.cache.object.near.cache.size") int maxSize) {
    this.daoCacheObjectNearCacheMaximumCacheSize = maxSize;
    return this;
  }

  @Inject(optional = true)
  public ActHazelcastConfiguration setEsEngineFactMaximumQueueSize(@Named("act.es.engine.fact.queue.size") int maxSize) {
